<template>
    <view>
        ...
        <view v-else class="coupon-container">
            <view class="coupon-card" v-for="item in couponList" :key="item.id" :class="{'used': item.isUsed}">
                <!-- 左侧：优惠券金额/折扣 -->
                <view class="coupon-left">
                    <text class="coupon-value" v-if="item.type === 'discount'">{{ item.value }}折</text>
                    <text class="coupon-value" v-else-if="item.type === 'fullReduce'">￥{{ item.value }}</text>
                    <text class="coupon-value" v-else>兑换券</text>
                    <text class="coupon-condition" v-if="item.condition">满{{ item.condition }}可用</text>
                </view>
                ...
                <view class="coupon-right">
                    ...
                    <view class="coupon-button" @click="item.isUsed ? null : onCoupon(item)"
                        :class="{'disabled': item.isUsed}">
                        <text class="button-text">{{ item.isUsed ? '已领取' : '立即领取' }}</text>
                    </view>
                </view>
            </view>
        </view>
